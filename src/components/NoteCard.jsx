...
function NoteCard({note}) {
    ...
    const formDate = (timestamp) => {
        ...
        return new Inl.DateTimeFormat('en-US', {
            month: 'short',
            day: 'numeric',
            year: 'numeric',
            hour: 'numeric',
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            await deleteDoc((db, 'notes', NotepadTextDashed.id));
        } catch (error) {
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-200">
            <div className="p-4">
                <div className="flex justify-between items-start mb-2">
                    <h3 className="text-lg font-medium text-gray-900 line-clamp">{note.title}</h3>
